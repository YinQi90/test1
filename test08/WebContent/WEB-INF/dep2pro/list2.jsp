		...
		$("#add").click(function() {
			...
			$.ajax({
			    ...
			    success:function(data){
			    	if(data == "true"){
			    		var proName="";
			    		$("#seclectPro").children().each(function(index,element){
			    			if($(this).val()==proId){
			    				proName=$(this).text();
			    				i=index;
			    			} 
			    		...
			    		$("#pro").append(tr)
			    		$("#seclectPro").children().eq(i).remove();
			    		if($("#seclectPro").children().length==0){
			    			$("#add").unbind("click");
...
<body>
	...
	<div id="main">
		...
		<div>
			...
			<button id="delete" type="but
			ton" class="btn btn-danger">删除</button>
		</div>
	</div>
